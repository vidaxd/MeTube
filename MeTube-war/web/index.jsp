...
<%@page import="control.VideoFacade"%>
...
<html>
    <%
        ...
        int pag = 0;
        List<Video> videos = (List<Video>) session.getAttribute("allVideos");
        if (request.getParameter("pag") == null) {
            ...
            session.setAttribute("allVideos", videos);
        } else {
    ...
    <head>
        ...
        <title>Bienvenido a MeTube</title>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                if(videos.size() > 0) {
                    if (pag == 1) {
                %>
                <li class="page-item disabled"><a class="page-link" href="index.jsp?pag=<%= pag - 1%>">Previous</a></li>
                    <%
                    } else {
                    %>
                <li class="page-item"><a class="page-link" href="index.jsp?pag=<%= pag - 1%>">Previous</a></li>
                ...
                <%
                    ...
                    for (int i = 1; i <= numPages; i++) {
                        if (i == pag) {
                %>
                <li class="page-item active"><a class="page-link" href="index.jsp?pag=<%= i%>"><%= i%></a></li>
                    <%
                        } else {
                    %>
                <li class="page-item"><a class="page-link" href="index.jsp?pag=<%= i%>"><%= i%></a></li>
                    <%
                            }
                        }
                    if(videos.size() > 0) {
                ...
                <li class="page-item disabled"><a class="page-link" href="index.jsp?pag=<%= pag + 1%>">Next</a></li>
                    <%
                        } else {
                    %>
                <li class="page-item"><a class="page-link" href="index.jsp?pag=<%= pag + 1%>">Next</a></li>
                    <%
                        }
                    }
                    %>
