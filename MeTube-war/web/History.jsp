...
<html>
    ...
    <head>
        ...
        <title>Historial de videos de la sesión </title>
    ...
    <body>
        <%
            ...
            if(request.getParameter("all") != null) svh = as.getHistoryByUser(request.getParameter("all"));
            int pag = 0;
            List<Video> videos = svh.getVideoViewed();
        ...
        <main class="fullScreen">
            <div class="py-4">
                <div class="container">
                    ...
                    <h1>No se han visualizado videos aún</h1>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <%
                    String historyOwner = "";
                    if(request.getParameter("all") != null)  historyOwner = "&all="+request.getParameter("all");
                    if (videos.size() > 0) {
                        if (pag == 1) {
                %>
                <li class="page-item disabled"><a class="page-link" href="History.jsp?pag=<%= pag - 1%><%= historyOwner %>">Previous</a></li>
                    <%
                    } else {
                    %>
                <li class="page-item"><a class="page-link" href="History.jsp?pag=<%= pag - 1%><%= historyOwner %>">Previous</a></li>
                ...
                <%
                    ...
                    for (int i = 1; i <= numPages; i++) {
                        if (i == pag) {
                %>
                <li class="page-item active"><a class="page-link" href="History.jsp?pag=<%= i%><%= historyOwner %>"><%= i%></a></li>
                    <%
                    } else {
                    %>
                <li class="page-item"><a class="page-link" href="History.jsp?pag=<%= i%><%= historyOwner %>"><%= i%></a></li>
                    <%
                            }
                        }
                        if (videos.size() > 0) {
                ...
                <li class="page-item disabled"><a class="page-link" href="History.jsp?pag=<%= pag + 1%><%= historyOwner %>">Next</a></li>
                    <%
                    } else {
                    %>
                <li class="page-item"><a class="page-link" href="History.jsp?pag=<%= pag + 1%><%= historyOwner %>">Next</a></li>
                    <%
                            }
                        }
                    %>
